...
if($run)
{
    ...
    {?><tr>
      ...
      <td><button class="btn btn-primary" style=" margin-left:2px;padding-left:40px; padding-right:40px">view</button></td>
      <td><button class="btn btn-danger" style=" margin-left:2px;padding-left:40px; padding-right:40px">delete</button></td>
      </tr>
      <?php
    }
}
